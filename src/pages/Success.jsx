  ...
  return (
    <div>
      <nav className=' flex items-center justify-between'>
        ...
        <div className=' flex flex-col gap-3 mt-[75px] md:mt-[100px]  items-center justify-center'>
            <div className=' bg-[#28B246] w-10 flex items-center justify-center text-white p-2  rounded-full' >
            <Check />
        </div>
      <h1 className='styleFont text-center '>Success Submitted</h1>
      <h2 className='heroHeading text-center text-3xl md:text-5xl lg:text-6xl'>Congratulations</h2>
      <p className=' text-[16px] md:text[20px] lg:text-[27px] text-[#727272] text-center w-[80%] lg:w-1/2 font-semibold'>Your request has been successfully submitted to us. We will validate your information and reach out to your shortly with updates</p>
        </div>

        <div className=' absolute flex items-center justify-center bottom-4 w-[90%] lg:w-[95%]'>
            <p className=' text-[18px] text-center lg:text-[20px] text-[#1C1C1C]  font-semibold'>
            Redirecting you to Homepage in <span className=' font-bold'>{timer} Seconds</span>
            </p>
        </div>
